...
public class JavaFXBoardGameView implements BoardGameControllableView {
    ...
    public synchronized void reset() {
        ...
        // Ajuster la taille de la fenêtre au contenu pour limiter les marges blanches
        stage.sizeToScene();
    }
